package com.java.cacheredis.utils.codegen;
...
public class MybatisPlusCodeGen {
    ...
    static final String dbName = "teaching_sys";
    ...
    public static void main(String[] args) {
        ...
        // 此处指定生成的代码文件在cache-redis的模块中, 此处需要添加该模块路径
        ...
        // 逆向的数据表名，可以包含多个
        strategy.setInclude("teacher", "student");
